...
function EditTableData({restX}) {
    ...
    return (
        <Fragment>
                ...
                <button type="button" className="btn btn-primary" data-toggle="modal" data-target={`#id${restX.restaurantid}`}>
                Open modal
                </button>


                <div className="modal" id={`id${restX.restaurantid}`}>
